...
insert into product_info values
	...
	(10,10,"学習机","がくしゅうつくえ","キッズルーム詳細1",3,40000,"./images/product","noimage.jpg",now(),"会社10",0,now(),now()),
	(11,11,"学習イス","がくしゅういす","キッズルーム詳細2",3,5000,"./images/product","noimage.jpg",now(),"会社11",0,now(),now()),
	(12,12,"二段ベッド","にだんべっど","キッズルーム詳細3",3,45000,"./images/product","noimage.jpg",now(),"会社12",0,now(),now()),
	(13,13,"ランドセルラック","らんどせるらっく","キッズルーム詳細4",3,6000,"./images/product","noimage.jpg",now(),"会社13",0,now(),now()),
	(14,14,"キッズカーテン","きっずかーてん","キッズルーム詳細5",3,3000,"./images/product","noimage.jpg",now(),"会社14",0,now(),now()),
	(15,15,"キッズラグ","きっずらぐ","キッズルーム詳細6",3,1000,"./images/product","noimage.jpg",now(),"会社15",0,now(),now()),
	(16,16,"小物トレー","こものとれー","キッズルーム詳細7",3,500,"./images/product","noimage.jpg",now(),"会社16",0,now(),now()),
	(17,17,"ぬいぐるみ","ぬいぐるみ","キッズルーム詳細8",3,1000,"./images/product","noimage.jpg",now(),"会社17",0,now(),now()),
	(18,18,"ウォールステッカー","うぉーるすてっかー","キッズルーム詳細9",3,500,"./images/product","noimage.jpg",now(),"会社18",0,now(),now()),
	(19,19,"食器棚","しょっきだな","キッチン詳細1",4,10000,"./images/product","noimage.jpg",now(),"会社19",0,now(),now()),
	(20,20,"レンジラック","れんじらっく","キッチン詳細2",4,8000,"./images/product","noimage.jpg",now(),"会社20",0,now(),now()),
	(21,21,"ダストボックス","だすとぼっくす","キッチン詳細3",4,1000,"./images/product","noimage.jpg",now(),"会社21",0,now(),now()),
	(22,22,"キッチンマット","きっちんまっと","キッチン詳細4",4,1200,"./images/product","noimage.jpg",now(),"会社22",0,now(),now()),
	(23,23,"調味料入れ","ちょうみりょういれ","キッチン詳細5",4,300,"./images/product","noimage.jpg",now(),"会社23",0,now(),now()),
	(24,24,"カトラリーケース","かとらりーけーす","キッチン詳細6",4,400,"./images/product","noimage.jpg",now(),"会社24",0,now(),now()),
	(25,25,"トレー","とれー","キッチン詳細7",4,1000,"./images/product","noimage.jpg",now(),"会社25",0,now(),now()),
	(26,26,"ランチョンマット","らんちょんまっと","キッチン詳細8",4,500,"./images/product","noimage.jpg",now(),"会社26",0,now(),now()),
	(27,27,"コースター","こーすたー","キッチン詳細9",4,200,"./images/product","noimage.jpg",now(),"会社27",0,now(),now()),
	(28,28,"ベッドフレーム","べっどふれーむ","ベッドルーム詳細1",5,25000,"./images/product","noimage.jpg",now(),"会社28",0,now(),now()),
	(29,29,"マットレス","まっとれす","ベッドルーム詳細2",5,25000,"./images/product","noimage.jpg",now(),"会社29",0,now(),now()),
	(30,30,"敷布団","しきふとん","ベッドルーム詳細3",5,5000,"./images/product","noimage.jpg",now(),"会社30",0,now(),now()),
	(31,31,"シーツ","しーつ","ベッドルーム詳細4",5,3000,"./images/product","noimage.jpg",now(),"会社31",0,now(),now()),
	(32,32,"ボックスシーツ","ぼっくすしーつ","ベッドルーム詳細5",5,3000,"./images/product","noimage.jpg",now(),"会社32",0,now(),now()),
	(33,33,"掛け布団","かけふとん","ベッドルーム詳細6",5,6000,"./images/product","noimage.jpg",now(),"会社33",0,now(),now()),
	(34,34,"掛け布団カバー","かけふとんかばー","ベッドルーム詳細7",5,3000,"./images/product","noimage.jpg",now(),"会社34",0,now(),now()),
	(35,35,"枕","まくら","ベッドルーム詳細8",5,3000,"./images/product","noimage.jpg",now(),"会社35",0,now(),now()),
